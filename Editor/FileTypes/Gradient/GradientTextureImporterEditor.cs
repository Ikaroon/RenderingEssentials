...
namespace Ikaroon.RenderingEssentialsEditor.FileTypes.Gradient
{
	...
	public class GradientTextureImporterEditor : ScriptedImporterEditor
	{
		public override void OnInspectorGUI()
		{
			...
			var gradientType = (GradientTextureImporter.GTData.GradientType)type.intValue;
			var size = serializedObject.FindProperty("<Data>k__BackingField.<GradientSteps>k__BackingField");
			EditorGUILayout.PropertyField(size);
			switch (gradientType)
			{
				case GradientTextureImporter.GTData.GradientType.Linear:
		...
		{
			var importer = (GradientTextureImporter)target;
